		...
		while (run) {
			...
			if (cLogin == 1) {
				...
				run = false;
					...
					String mapwd = sc.nextLine();
					if(mpwd.equals(mapwd)) {
						cdao.cCtm(mid, mapwd);
			...
			if(cList==1) {
				...
				while(a) {
					...
					for(int i = 0; i<gList.size();i++) {
						if(gList.get(i).getSumLike()>=5) {
							System.out.print(Fcolor.blue + gList.get(i).getBoardNo()+ Fcolor.exit+"\t\t");
							System.out.print(Fcolor.blue + gList.get(i).getTitle()+ Fcolor.exit+"\t\t ");
							System.out.print(Fcolor.blue + gList.get(i).getWriter()+ Fcolor.exit+"\t\t");
							System.out.print(Fcolor.blue + gList.get(i).getMdate()+ Fcolor.exit+"\t\t ");
							System.out.println(Fcolor.blue + gList.get(i).getSumLike()+ Fcolor.exit);

						}else if(gList.get(i).getSumLike()<=-5) {
							System.out.print(Fcolor.white + gList.get(i).getBoardNo()+ Fcolor.exit+"\t\t");
							System.out.print(Fcolor.white + gList.get(i).getTitle()+ Fcolor.exit+"\t\t ");
							System.out.print(Fcolor.white + gList.get(i).getWriter()+ Fcolor.exit+"\t\t");
							System.out.print(Fcolor.white + gList.get(i).getMdate()+ Fcolor.exit+"\t\t ");
							System.out.println(Fcolor.white + gList.get(i).getSumLike()+ Fcolor.exit);
			...
			if(cList==2) {
				...
				while(a) {
					...
					for(int i = 0; i<mList.size();i++) {
						if(mList.get(i).getSumLike()>=5) {
							System.out.print(Fcolor.blue + mList.get(i).getBoardNo()+ Fcolor.exit+"\t\t");
							System.out.print(Fcolor.blue + mList.get(i).getTitle()+ Fcolor.exit+"\t\t ");
							System.out.print(Fcolor.blue + mList.get(i).getWriter()+ Fcolor.exit+"\t\t");
							System.out.print(Fcolor.blue + mList.get(i).getMdate()+ Fcolor.exit+"\t\t ");
							System.out.println(Fcolor.blue + mList.get(i).getSumLike()+ Fcolor.exit);

						}else if(mList.get(i).getSumLike()<=-5) {
							System.out.print(Fcolor.white + mList.get(i).getBoardNo()+ Fcolor.exit+"\t\t");
							System.out.print(Fcolor.white + mList.get(i).getTitle()+ Fcolor.exit+"\t\t ");
							System.out.print(Fcolor.white + mList.get(i).getWriter()+ Fcolor.exit+"\t\t");
							System.out.print(Fcolor.white + mList.get(i).getMdate()+ Fcolor.exit+"\t\t ");
							System.out.println(Fcolor.white + mList.get(i).getSumLike()+ Fcolor.exit);
			...
			if(cList==3) {
				...
				while(a) {
					...
					for(int i = 0; i<bList.size();i++) {
						if(bList.get(i).getSumLike()>=5) {
							System.out.print(Fcolor.blue + bList.get(i).getBoardNo()+ Fcolor.exit+"\t\t");
							System.out.print(Fcolor.blue + bList.get(i).getTitle()+ Fcolor.exit+"\t\t ");
							System.out.print(Fcolor.blue + bList.get(i).getWriter()+ Fcolor.exit+"\t\t");
							System.out.print(Fcolor.blue + bList.get(i).getMdate()+ Fcolor.exit+"\t\t ");
							System.out.println(Fcolor.blue + bList.get(i).getSumLike()+ Fcolor.exit);

						}else if(bList.get(i).getSumLike()<=-5) {
							System.out.print(Fcolor.white + bList.get(i).getBoardNo()+ Fcolor.exit+"\t\t");
							System.out.print(Fcolor.white + bList.get(i).getTitle()+ Fcolor.exit+"\t\t ");
							System.out.print(Fcolor.white + bList.get(i).getWriter()+ Fcolor.exit+"\t\t");
							System.out.print(Fcolor.white + bList.get(i).getMdate()+ Fcolor.exit+"\t\t ");
							System.out.println(Fcolor.white + bList.get(i).getSumLike()+ Fcolor.exit);
